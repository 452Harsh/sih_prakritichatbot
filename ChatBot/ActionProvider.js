...
class ActionProvider{
  ...
  handleHello = () => {
    ...
    const question_1 = this.createChatBotMessage(
       "Body Frame",
       {
         widget: "question_1",
       }
  ...
  question_2 = () => {
    const question_2 = this.createChatBotMessage(
       "Nails Colour",
       {
         widget: "question_2",
       }
  ...
  question_3 = () => {
    const question_3 = this.createChatBotMessage(
       "Finger Nail size",
       {
         widget: "question_3",
       }
  ...
  question_4 = () => {
    const question_4 = this.createChatBotMessage(
       "Skin Texture",
       {
         widget: "question_4",
       }
  ...
  question_5 = () => {
    const question_5 = this.createChatBotMessage(
       "Hair Texture",
       {
         widget: "question_5",
       }
